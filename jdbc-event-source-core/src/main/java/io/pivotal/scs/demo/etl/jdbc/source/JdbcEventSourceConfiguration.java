 ...
 */
@EnableBinding(JdbcEventSource.class)
@Import(TriggerConfiguration.class)
@EnableConfigurationProperties({JdbcEventSourceProperties.class, TriggerPropertiesMaxMessagesDefaultOne.class})
public class JdbcEventSourceConfiguration {

	@Autowired
	private JdbcEventSourceProperties properties;

	@Autowired
	private DataSource dataSource;

	@Autowired
	private JdbcEventSource source;
